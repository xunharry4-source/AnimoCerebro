...
from zentex.tasks.decomposition_plugin_llm import TaskDecompositionPlugin as LLMTaskDecompositionPlugin, TaskDecompositionPluginSpec, TaskDecompositionStrategy
...
class TaskPluginRegistry(AbstractPluginRegistry[TaskDecompositionPluginSpec]):
    ...
    def set_default_decomposition_plugin(self, plugin_id: str) -> bool:
        ...
        if plugin_spec.status != PluginLifecycleStatus.ACTIVE:
    ...
    def promote_plugin_to_active(self, plugin_id: str, audit_reason: str) -> bool:
        ...
        try:
            ...
            if plugin_id in self._plugins:
                ...
                if current_spec.status == PluginLifecycleStatus.CANDIDATE:
