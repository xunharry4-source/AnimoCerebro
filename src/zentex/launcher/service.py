...
class LauncherService:
    ...
    def __init__(self) -> None:
        ...
        self._config: StartupConfig | None = None
    ...
    def _load_and_validate(self, config: StartupConfig | None) -> StartupConfig:
    ...
    def start_web(self, config: StartupConfig | None = None) -> object:
    ...
    def start_daemon(self, config: StartupConfig | None = None) -> DaemonController:
    ...
    def get_foundation_service(self) -> object | None:
    ...
    def get_kernel_service(self) -> object | None:
    ...
    def get_memory_service(self) -> object | None:
    ...
    def get_plugins_service(self) -> object | None:
...
_default_launcher: LauncherService | None = None
