...
FEATURE_EXPLANATIONS = {
    ...
    "nine_questions.q1": "负责判断当前系统所处环境、工作区结构和外部态势,回答'我在那'。",
    "nine_questions.q2": "负责盘点当前可用工具、Agent、工作区与权限资产,回答'我有什么'。",
    "nine_questions.q3": "负责结合 Q1 态势与身份约束,判断当前系统扮演的角色与使命边界,回答'我是谁'。",
    "nine_questions.q4": "负责基于真实资产与执行域,判断系统当前真正具备的行动能力,回答'我能干什么'。",
    "nine_questions.q5": "负责基于授权与合规边界,对可行动作做减法裁剪,回答'我可以干什么'。",
    "nine_questions.q6": "负责推演受控进化方向、能力缺口、禁止边界与验证门槛,回答'我该如何进化'。",
    "nine_questions.q7": "负责在主路径受阻时生成备选策略、降级路径和协作切换方案,回答'我还可以做什么'。",
    "nine_questions.q8": "负责汇总 Q1-Q7 的约束与能力,生成当前最优主目标和任务队列,回答'我应该干什么'。",
    "nine_questions.q9": "负责根据 Q1-Q8 的状态确定行动姿态、节奏和确认策略,回答'我应该怎么做'。",
