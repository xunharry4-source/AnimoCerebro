    ...
    for asset in service.manager.list_assets():
        ...
        records.append(
            AgentConsoleRecord(
                ...
                adapter_config=dict(asset.adapter_config),
                auth_config=service.public_auth_config_for_agent(asset.agent_id),
                service_hooks=list(getattr(asset, "service_hooks", [])),
                protocol_capabilities=list(asset.protocol_capabilities),
...
def handle_get_agent_detail(
    ...
    return {
        ...
        "adapter_type": asset.adapter_type,
        "adapter_config": dict(asset.adapter_config),
        "auth_config": agent_service.public_auth_config_for_agent(asset.agent_id),
        "service_hooks": list(getattr(asset, "service_hooks", [])),
        "protocol_capabilities": list(asset.protocol_capabilities),
        "latency_ms": asset.latency_ms,
        "success_rate": asset.success_rate,
