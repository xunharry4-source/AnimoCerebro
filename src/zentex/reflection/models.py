...
class ReflectionItem(BaseModel):
    ...
    reflection_object: Optional[str] = Field(default=None, description="被反思对象的完整可读名称")
    failure_fact: Optional[str] = Field(default=None, description="已发生或已识别的失败事实")
    root_cause: Optional[str] = Field(default=None, description="导致失败事实的原因")
    improvement_direction: Optional[str] = Field(default=None, description="后续改进方向")
