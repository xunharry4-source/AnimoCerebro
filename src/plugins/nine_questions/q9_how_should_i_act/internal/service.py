...
from plugins.nine_questions.q8_what_should_i_do_now.llm_output_table import (
    load_internal_llm_output_from_table as load_q8_internal_llm_output_from_table,
)
...
def _build_q9_internal_upstream_context(context: dict[str, Any]) -> dict[str, Any]:
    ...
    upstream["Q8_InternalObjectiveProfile"] = load_q8_internal_llm_output_from_table(
