...
def _log(event: str, **fields: Any) -> None:
    observable_event(
        logger,
        event,
        component="nine_questions.q9.internal",
        question_id="q9",
        scope="internal",
        **fields,
    )
...
def run_q9_internal_llm_and_save(context: dict[str, Any]) -> dict[str, Any]:
    ...
    upstream_context = _build_q9_internal_upstream_context(context)
    _log(
    ...
    request = build_q9_internal_llm_request(context=upstream_context)
