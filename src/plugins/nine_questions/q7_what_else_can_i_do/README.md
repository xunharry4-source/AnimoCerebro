...
2. **官方加载器路径 (Official Loader Methods)**:
   - 必须通过上游 Q6 提供的对外读取方法从 SQLite 权威状态库中读取数据。
   - 核心方法：`from plugins.nine_questions.q6_what_should_i_not_do.service import load_internal_public_output, load_external_public_output`
