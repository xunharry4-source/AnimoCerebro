...
def _build_q7_internal_upstream_context(context: dict[str, Any]) -> dict[str, Any]:
    ...
    constraint_slice = context.get("q7_q6_internal_constraint_slice")
    if isinstance(constraint_slice, dict) and constraint_slice:
        upstream["Q6_InternalPlanConstraintSet"] = constraint_slice
    else:
        upstream["Q6_InternalPlanConstraintSet"] = load_q6_internal_public_output(
