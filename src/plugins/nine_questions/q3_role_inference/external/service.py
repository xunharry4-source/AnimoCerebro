...
def _load_q1_llm_analysis_result(*, db_path: Any, session_id: str) -> dict[str, Any]:
    q1_llm_output = load_q1_public_output(db_path=db_path, session_id=session_id)
...
def _load_q3_external_prompt_context(context: dict[str, Any], *, session_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "q2_external_llm_output": load_q2_external_public_output(db_path=db_path, session_id=session_id),
    }
