...
def _extract_q4_external_objective_numbers(context: dict[str, Any]) -> set[str]:
    ...
    if isinstance(prompt_context, dict) and "Q4_ExternalObjectiveCandidates" not in prompt_context:
...
def generate_external_goal_compliance_assessment_with_instructor_contract(
    ...
    *,
    ...
    if not q4_objective_numbers:
        raise RuntimeError("q5_external_instructor_validation_failed:q4_candidate_objective_numbers_missing")
