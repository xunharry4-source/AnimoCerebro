...
- blocked_internal_objectives 中每个对象必须包含 objective 和 violation_reason。
...
- allowed_internal_objectives_with_conditions 中每个对象必须包含 objective 和 compliance_condition；compliance_condition 必须是具体受控前提，禁止写“无”“无条件”“可执行”“不需要限制”。
