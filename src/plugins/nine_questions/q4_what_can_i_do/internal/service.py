...
from plugins.nine_questions.q2_asset_inventory.llm_output_table import (
    load_internal_function_signal_from_table as load_q2_internal_function_signal_from_table,
)
...
def _build_internal_prompt_context(context: dict[str, Any]) -> dict[str, Any]:
    ...
    q2_internal_output = load_q2_internal_function_signal_from_table(db_path=db_path, session_id=session_id)
