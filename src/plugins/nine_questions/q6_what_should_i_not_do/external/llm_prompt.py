...
def _extract_q5_allowed_external_objectives(context: dict[str, Any]) -> Any:
    objective_slice = context.get("q6_q5_external_objective_slice")
    ...
    q5_output = q5_public_output["q5_external_authorization_boundary"]
...
def _extract_execution_rights_matrix(context: dict[str, Any]) -> Any:
    ...
    q5_input = q5_public_output.get("q5_external_llm_input")
